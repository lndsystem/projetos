INSERT INTO [prodkit_inspire].[dbo].[processamento] (id_requisicao,id_job,id_lote,id_cliente_global,id_sistema_global,id_status,ambiente,identificacao_externa,tipo_execucao,data_cadastro) VALUES 
